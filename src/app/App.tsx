      ...
      {!introDismissed && (
        ...
        >
          <div className="intro-card">
            ...
            <h2 id="intro-title">
              The model may propose. <em>Aether must prove.</em>
            </h2>
            <p className="intro-lede">
              A payment platform is losing its Mumbai region. You and an AI
              agent work the same live system model — branch a repair, simulate
              the consequence, and decide together.
            </p>
            <ol className="intro-steps">
              <li>
                <b>1</b>
                <span>
                  <strong>Branch a future</strong>
                  Test a repair in isolation. Production never changes.
                </span>
              </li>
              <li>
                <b>2</b>
                <span>
                  <strong>Prove it deterministically</strong>
                  Failure propagates along real dependency edges. Every metric
                  is computed, never generated by a model.
                </span>
              </li>
              <li>
                <b>3</b>
                <span>
                  <strong>You hold the gate</strong>
                  The agent can propose and explain. Only a human can approve or
                  merge — there is no agent merge tool.
                </span>
              </li>
            </ol>
