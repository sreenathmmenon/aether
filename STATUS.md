...
Latest live release checked from Railway during the 2026-09-03 readiness audit: deployment `f03024e9-aea5-4c69-873d-2d13131485f5`, service online at `https://webmcp-production-38e5.up.railway.app`, PostgreSQL-backed `/health`, origin-isolation headers, WebMCP origin-trial header, `Permissions-Policy: tools=(self)`, and browser-visible WebMCP discovery showing ten tools on a committed seeded architecture, sixteen tools on the blank editable architecture, and eighteen tools once a repair future exists.
