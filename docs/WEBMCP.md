...
| Build   | `add_architecture_component`, `connect_components`                                                           | Yes           | The model is editable: a repair future is open, or the reviewer is building their own system on an empty canvas. Every addition is reversible |
