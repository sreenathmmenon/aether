...
9. Close on the WebMCP surface: ten tools on committed systems, sixteen tools while modeling, eighteen tools once a future exists, and no approve or merge tool.
