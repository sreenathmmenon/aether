...
9. Close on the WebMCP surface: five tools on committed systems, nine tools while modeling, eleven tools once a future exists, and no approve or merge tool.
